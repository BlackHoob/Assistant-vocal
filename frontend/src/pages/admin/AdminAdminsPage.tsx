    ...
    <div className="p-8 text-gray-200">
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={() => setShowForm(!showForm)}
          className="bg-orange-500 text-white text-sm font-medium px-4 py-2 rounded-xl hover:bg-orange-600 transition-all flex items-center gap-2">
      ...
      {showForm && (
        <div className="bg-gray-900 border border-orange-500/20 rounded-2xl p-5 mb-6">
          <h3 className="text-sm font-semibold text-white mb-4">Créer un administrateur</h3>
          ...
          <form onSubmit={handleCreate} className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <div className="relative">
                <input type={showPwd ? 'text' : 'password'} required value={form.password}
                  ...
                  className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-xl text-sm text-gray-200 placeholder-gray-600 outline-none focus:border-orange-500 transition-colors pr-9"
            ...
            <div>
              ...
              <select value={form.role} onChange={e => setForm({ ...form, role: e.target.value })}
                className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-xl text-sm text-gray-200 outline-none focus:border-orange-500">
            ...
            <div className="col-span-2">
              <button type="submit" disabled={submitting}
                className="bg-orange-500 text-white text-sm px-4 py-2 rounded-xl hover:bg-orange-600 transition-all flex items-center gap-2">
              ...
              <tr key={a.id} className="border-b border-gray-800/50 hover:bg-gray-800/30 transition-colors">
                <td className="px-5 py-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-200 font-medium">{a.username}</span>
                ...
                <td className="px-5 py-3">
                  <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs border ${
                    a.role === 'superadmin' ? 'bg-orange-500/10 text-orange-400 border-orange-500/20' : 'bg-gray-700 text-gray-400 border-gray-600'
                  }`}>{a.role}</span>
                </td>
